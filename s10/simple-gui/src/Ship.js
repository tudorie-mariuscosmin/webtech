        ...
        return (
            <div>
                {this.state.isEditing ?
                    <>
                        <span><input type="text" value={this.state.name} name="name" onChange={this.handleChange} /></span>
                        <span><input type="text" value={this.state.portOfSail} name="portOfSail" onChange={this.handleChange} /></span>
                        <span><input type="text" value={this.state.displacement} name="displacement" onChange={this.handleChange} /></span>
                        <span>
