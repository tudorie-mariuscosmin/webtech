    ...
    render() {
        return (
            <div>
                ...
                <div>
                    <label htmlFor="portOfSail">Port of Sail</label>
                ...
                <div>
                    ...
                    <input type="number" id='displacement' name='displacement' value={this.state.displacement} onChange={this.handleChange} />
                </div>
                <div>
